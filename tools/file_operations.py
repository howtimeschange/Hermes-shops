...
# Kept for backward compatibility / introspection, but _is_write_denied()
# rebuilds from the current HOME/HERMES_HOME so tests and profile overrides
# are respected after import time.
