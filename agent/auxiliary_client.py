...
def get_vision_auxiliary_client(
    *,
    ...
    """Return (client, model) for vision-capable auxiliary tasks."""
    _provider, client, model = resolve_vision_provider_client(main_runtime=main_runtime)
    return client, model
        ...
        if main_provider and main_provider not in ("auto", ""):
            if main_provider in _VISION_AUTO_PROVIDER_ORDER:
                ...
                rpc_client, rpc_model = resolve_provider_client(
                    main_provider, vision_model, main_runtime=main_runtime)
